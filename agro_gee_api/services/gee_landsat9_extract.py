...
class Landsat9ExtractService:
    _SUPPORTED_METRICS = {"ndvi_mean", "ndwi_mean", "ndre_mean"}
    ...
    def extract_point(
        ...
        *,
        ...
        try:
            return self._gee_client.extract_point_landsat9(
    ...
    def extract_polygon(
        ...
        *,
        ...
        self._validate_inputs(date_start=date_start, date_end=date_end, metric=metric)
        return self._gee_client.extract_polygon_landsat9(
            geometry_geojson=geometry_geojson,
            date_start=date_start.isoformat(),
            date_end=date_end.isoformat(),
            metric=metric,
    ...
    def timeseries(
        ...
        *,
        ...
        self._validate_inputs(date_start=date_start, date_end=date_end, metric=metric)
        return self._gee_client.timeseries_landsat9(
            geometry_geojson=geometry_geojson,
            date_start=date_start.isoformat(),
            date_end=date_end.isoformat(),
            metric=metric,
